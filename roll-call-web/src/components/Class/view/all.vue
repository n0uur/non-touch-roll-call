    ...
    <div>
        <div class="container bg-light mt-3">
            <div class="row mt-3 mb-3">
                <div class="col mt-2">
                    <h3><i class="fas fa-users" @click="$router.push({name: 'registerStudent'})"></i> หน้ารวมห้องเรียน <i @click="getAllClass()" class="fas fa-redo-alt text-primary hover-trans" style="font-size: 15px"></i> 
                ...
                <div class="col">
                    <table class="table table">
                        <thead class="thead-light">
                            <tr>
                                <th><i class="fas fa-user-circle"></i> รหัสห้องเรียน</th>
                                <th><i class="fas fa-list"></i> วิชา</th>
                                <th><i class="fas fa-user"></i> ผู้สอน</th>
                                <th><i class="far fa-clock"></i> เวลาที่สร้าง</th>
                                <th><i class="fas fa-users"></i> จำนวนนักเรียนในห้อง</th>
                                <th><i class="fas fa-check-square"></i> สถานะ</th>
                                <th><i class="fas fa-check-square"></i> ไปยังห้องเรียน</th>
                            </tr>
                        </thead>
                        <tbody v-if="allClass.length">
                            <tr v-for="rclass in allClassroom" :key="rclass.Class_ID">
                                ...
                                <td class="text-center">
                                    <button class="btn btn-primary btn-block" @click="$router.push({path: '/class/view/' + rclass.Class_ID})">
